#import "../with_mint_and_burn/FA2_multi_asset.mligo" "FA2_multi_asset"
...
let test_mint_correct = 
  ...
  let _ = Test.transfer_to_contract_exn contr (Mint_token [{owner = owner1; token_id = 10n; amount_ = 10n}; {owner = owner1; token_id = 11n; amount_ = 20n}; ]) 0tez in
  ()
...
let test_mint_wrong_sender = 
  ...
  let _ = Test.transfer_to_contract_exn contr (Create_token {token_id = 11n; data = {token_id=11n;token_info=(Map.empty : (string, bytes) map)}}) 0tez in
  let () = Test.set_source owner2 in
  let result = Test.transfer_to_contract contr (Mint_token [{owner = owner1; token_id = 10n; amount_ = 10n}; {owner = owner1; token_id = 11n; amount_ = 20n}; ]) 0tez in
  match result with
    Success _gas -> failwith "This test should fail"
  | Fail (Rejected (err, _))  -> assert (Test.michelson_equal err (Test.eval FA2_multi_asset.Errors.requires_admin))
  | Fail _ -> failwith "invalid test failure"
...
let test_mint_wrong_token =
  ...
  let () = Test.set_source owner1 in
  let _ = Test.transfer_to_contract_exn contr (Create_token {token_id = 10n; data = {token_id=10n;token_info=(Map.empty : (string, bytes) map)}}) 0tez in
  let result = Test.transfer_to_contract contr (Mint_token [{owner = owner1; token_id = 11n; amount_ = 10n}]) 0tez in
  match result with
    Success _gas -> failwith "This test should fail"
  | Fail (Rejected (err, _))  -> assert (Test.michelson_equal err (Test.eval FA2_multi_asset.Errors.undefined_token))
  | Fail _ -> failwith "invalid test failure"
...
let test_burn_token_correct = 
  ...
  let () = Test.set_source owner1 in
  let _ = Test.transfer_to_contract_exn contr (Create_token {token_id = 10n; data = {token_id=10n;token_info=(Map.empty : (string, bytes) map)}}) 0tez in
  let _ = Test.transfer_to_contract_exn contr (Mint_token [{owner = owner1; token_id = 10n; amount_ = 10n}]) 0tez in
  let _ = Test.transfer_to_contract_exn contr (Burn_token [{owner = owner1; token_id = 10n; amount_ = 10n}]) 0tez in
  ()
...
let test_burn_token_wrong_too_much = 
  ...
  let _ = Test.transfer_to_contract_exn contr (Create_token {token_id = 10n; data = {token_id=10n;token_info=(Map.empty : (string, bytes) map)}}) 0tez in
  let _ = Test.transfer_to_contract_exn contr (Mint_token [{owner = owner1; token_id = 10n; amount_ = 10n}]) 0tez in
  let result = Test.transfer_to_contract contr (Burn_token [{owner = owner1; token_id = 10n; amount_ = 12n}]) 0tez in
  match result with
    Success _gas -> failwith "This test should fail"
  | Fail (Rejected (err, _))  -> assert (Test.michelson_equal err (Test.eval FA2_multi_asset.Errors.ins_balance))
  | Fail _ -> failwith "invalid test failure"
...
let test_burn_token_wrong_sender = 
  ...
  let _ = Test.transfer_to_contract_exn contr (Mint_token [{owner = owner1; token_id = 10n; amount_ = 10n}]) 0tez in
  let () = Test.set_source owner2 in
  let result = Test.transfer_to_contract contr (Burn_token [{owner = owner1; token_id = 10n; amount_ = 10n}]) 0tez in
  match result with
    Success _gas -> failwith "This test should fail"
  | Fail (Rejected (err, _))  -> assert (Test.michelson_equal err (Test.eval FA2_multi_asset.Errors.requires_admin))
  | Fail _ -> failwith "invalid test failure"
...
let test_burn_token_wrong_token = 
  ...
  let _ = Test.transfer_to_contract_exn contr (Create_token {token_id = 10n; data = {token_id=10n;token_info=(Map.empty : (string, bytes) map)}}) 0tez in
  let _ = Test.transfer_to_contract_exn contr (Mint_token [{owner = owner1; token_id = 10n; amount_ = 10n}]) 0tez in
  let result = Test.transfer_to_contract contr (Burn_token [{owner = owner1; token_id = 55n; amount_ = 10n}]) 0tez in
  match result with
    Success _gas -> failwith "This test should fail"
  | Fail (Rejected (err, _))  -> 
